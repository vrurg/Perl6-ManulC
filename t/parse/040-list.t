...
subtest "Items with bodies" => {
    my @tests =
                ...
                },
                {
                    ...
                    struct => ManulC::Parser::MD::MdDoc.new(content => [ManulC::Parser::MD::MdList.new(content => [ManulC::Parser::MD::MdLiItem.new(starter => ManulC::Parser::MD::MdLiItemStart.new(align => "", spacing => " ", value => ManulC::Parser::MD::MdLiNumDotStart.new(number => "1", value => ".", type => "LiNumDotStart"), type => "LiItemStart"), content => [ManulC::Parser::MD::MdLiItemText.new(content => [ManulC::Parser::MD::MdPlainStr.new(value => "Item 1", type => "PlainStr")], type => "LiItemText"), ManulC::Parser::MD::MdCodeblockFenced.new(language => Str, comment => Str, value => "1. just a code block\n1. of Item 1\n", type => "CodeblockFenced")], type => "LiItem")], type => "List")], type => "Doc"),
                },
                {
                    text => q:to/TST/,
                            1. Item 1
                    ...
                    struct => ManulC::Parser::MD::MdDoc.new(content => [ManulC::Parser::MD::MdList.new(content => [ManulC::Parser::MD::MdLiItem.new(starter => ManulC::Parser::MD::MdLiItemStart.new(align => "", spacing => " ", value => ManulC::Parser::MD::MdLiNumDotStart.new(number => "1", value => ".", type => "LiNumDotStart"), type => "LiItemStart"), content => [ManulC::Parser::MD::MdLiItemText.new(content => [ManulC::Parser::MD::MdPlainStr.new(value => "Item 1\n           ", type => "PlainStr"), ManulC::Parser::MD::MdVerbatim.new(marker => "``", space => Str, content => [ManulC::Parser::MD::MdChrSpecial.new(value => "`", type => "ChrSpecial"), ManulC::Parser::MD::MdPlainStr.new(value => "\n           1. just a code block\n           1. of Item 1\n           ", type => "PlainStr")], type => "Verbatim"), ManulC::Parser::MD::MdChrSpecial.new(value => "`", type => "ChrSpecial")], type => "LiItemText")], type => "LiItem")], type => "List")], type => "Doc"),
                },
                {
                    text => q:to/TST/,
                            - Item 1
                ...
                },
                {
                    ...
                    struct => ManulC::Parser::MD::MdDoc.new(link-definitions => {"link 1" => ManulC::Parser::MD::MdLinkDefinition.new(id => "link 1", addr => ManulC::Parser::MD::MdLinkdefAddr.new(value => ManulC::Parser::MD::MdPlainStr.new(value => "http://foo.foo", type => "PlainStr"), type => "LinkdefAddr"), title => ManulC::Parser::MD::MdLine, indent => Str, attrs => ManulC::Parser::MD::MdAttributes, type => "LinkDefinition"), "link 2" => ManulC::Parser::MD::MdLinkDefinition.new(id => "link 2", addr => ManulC::Parser::MD::MdLinkdefAddr.new(value => ManulC::Parser::MD::MdPlainStr.new(value => "http://goo.gle", type => "PlainStr"), type => "LinkdefAddr"), title => ManulC::Parser::MD::MdLine, indent => Str, attrs => ManulC::Parser::MD::MdAttributes, type => "LinkDefinition"), "link 3" => ManulC::Parser::MD::MdLinkDefinition.new(id => "link 3", addr => ManulC::Parser::MD::MdLinkdefAddr.new(value => ManulC::Parser::MD::MdPlainStr.new(value => "http://google.com", type => "PlainStr"), type => "LinkdefAddr"), title => ManulC::Parser::MD::MdLine, indent => Str, attrs => ManulC::Parser::MD::MdAttributes, type => "LinkDefinition")}, content => [ManulC::Parser::MD::MdList.new(content => [ManulC::Parser::MD::MdLiItem.new(starter => ManulC::Parser::MD::MdLiItemStart.new(align => "", spacing => " ", value => ManulC::Parser::MD::MdLiBulletStart.new(value => "-", type => "LiBulletStart"), type => "LiItemStart"), content => [ManulC::Parser::MD::MdParagraph.new(content => [ManulC::Parser::MD::MdLine.new(content => [ManulC::Parser::MD::MdPlainStr.new(value => "Item 1", type => "PlainStr")], type => "Line"), ManulC::Parser::MD::MdEol.new(value => "\n", type => "Eol"), ManulC::Parser::MD::MdBlankSpace.new(value => "\n", type => "BlankSpace")], type => "Paragraph"), ManulC::Parser::MD::MdLinkdefParagraph.new(content => [ManulC::Parser::MD::MdLinkDefinition.new(id => "link 1", addr => ManulC::Parser::MD::MdLinkdefAddr.new(value => ManulC::Parser::MD::MdPlainStr.new(value => "http://foo.foo", type => "PlainStr"), type => "LinkdefAddr"), title => ManulC::Parser::MD::MdLine, indent => Str, attrs => ManulC::Parser::MD::MdAttributes, type => "LinkDefinition"), ManulC::Parser::MD::MdEol.new(value => "\n", type => "Eol"), ManulC::Parser::MD::MdLinkDefinition.new(id => "link 2", addr => ManulC::Parser::MD::MdLinkdefAddr.new(value => ManulC::Parser::MD::MdPlainStr.new(value => "http://goo.gle", type => "PlainStr"), type => "LinkdefAddr"), title => ManulC::Parser::MD::MdLine, indent => Str, attrs => ManulC::Parser::MD::MdAttributes, type => "LinkDefinition"), ManulC::Parser::MD::MdEol.new(value => "\n", type => "Eol"), ManulC::Parser::MD::MdBlankSpace.new(value => "\n", type => "BlankSpace")], type => "LinkdefParagraph"), ManulC::Parser::MD::MdLinkdefParagraph.new(content => [ManulC::Parser::MD::MdLinkDefinition.new(id => "link 3", addr => ManulC::Parser::MD::MdLinkdefAddr.new(value => ManulC::Parser::MD::MdPlainStr.new(value => "http://google.com", type => "PlainStr"), type => "LinkdefAddr"), title => ManulC::Parser::MD::MdLine, indent => Str, attrs => ManulC::Parser::MD::MdAttributes, type => "LinkDefinition"), ManulC::Parser::MD::MdEol.new(value => "\n", type => "Eol")], type => "LinkdefParagraph")], type => "LiItem")], type => "List")], type => "Doc"),
                },
                ;
    md-test-structure( @tests );
}
