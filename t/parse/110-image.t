...
subtest "Valid" => {
    my @tests =
        ...
        },
        {
            ...
            struct => ManulC::Parser::MD::MdDoc.new(link-definitions => {}, content => [ManulC::Parser::MD::MdParagraph.new(content => [ManulC::Parser::MD::MdLine.new(content => [ManulC::Parser::MD::MdPlainStr.new(value => "!", type => "PlainStr"), ManulC::Parser::MD::MdChrSpecial.new(value => "[", type => "ChrSpecial"), ManulC::Parser::MD::MdPlainStr.new(value => "Image text", type => "PlainStr"), ManulC::Parser::MD::MdChrSpecial.new(value => "]", type => "ChrSpecial"), ManulC::Parser::MD::MdChrSpecial.new(value => "(", type => "ChrSpecial"), ManulC::Parser::MD::MdPlainStr.new(value => "/img/foo.jpg \"My title\"", type => "PlainStr"), ManulC::Parser::MD::MdChrSpecial.new(value => ")", type => "ChrSpecial")], type => "Line"), ManulC::Parser::MD::MdEol.new(value => "", type => "Eol")], type => "Paragraph")], type => "Doc"),
        },
        {
            text => q{![Image "text" > &](/img/foo.jpg "My \"title\"")},
            name => "image with special and quoted chars",
            struct => ManulC::Parser::MD::MdDoc.new(link-definitions => {}, content => [ManulC::Parser::MD::MdParagraph.new(content => [ManulC::Parser::MD::MdLine.new(content => [ManulC::Parser::MD::MdPlainStr.new(value => "!", type => "PlainStr"), ManulC::Parser::MD::MdChrSpecial.new(value => "[", type => "ChrSpecial"), ManulC::Parser::MD::MdPlainStr.new(value => "Image \"text\" ", type => "PlainStr"), ManulC::Parser::MD::MdChrSpecial.new(value => ">", type => "ChrSpecial"), ManulC::Parser::MD::MdPlainStr.new(value => " ", type => "PlainStr"), ManulC::Parser::MD::MdChrSpecial.new(value => "\&", type => "ChrSpecial"), ManulC::Parser::MD::MdChrSpecial.new(value => "]", type => "ChrSpecial"), ManulC::Parser::MD::MdChrSpecial.new(value => "(", type => "ChrSpecial"), ManulC::Parser::MD::MdPlainStr.new(value => "/img/foo.jpg \"My ", type => "PlainStr"), ManulC::Parser::MD::MdChrEscaped.new(value => "\"", type => "ChrEscaped"), ManulC::Parser::MD::MdPlainStr.new(value => "title", type => "PlainStr"), ManulC::Parser::MD::MdChrEscaped.new(value => "\"", type => "ChrEscaped"), ManulC::Parser::MD::MdPlainStr.new(value => "\"", type => "PlainStr"), ManulC::Parser::MD::MdChrSpecial.new(value => ")", type => "ChrSpecial")], type => "Line"), ManulC::Parser::MD::MdEol.new(value => "", type => "Eol")], type => "Paragraph")], type => "Doc"),
        },
        {
