    ...
    my @tests =
        {
            ...
            name => 'simple image',
            struct => ManulC::Parser::MD::MdDoc.new(content => [ManulC::Parser::MD::MdParagraph.new(content => [ManulC::Parser::MD::MdLine.new(content => [ManulC::Parser::MD::MdImage.new(link => ManulC::Parser::MD::MdLinkAdhoc.new(title => ManulC::Parser::MD::MdLinkAddrTitle, text => ManulC::Parser::MD::MdLinkText.new(content => [ManulC::Parser::MD::MdLine.new(content => [ManulC::Parser::MD::MdPlainStr.new(value => "Image text", type => "PlainStr")], type => "Line")], type => "LinkText"), addr => ManulC::Parser::MD::MdLinkAddr.new(value => "/img/foo.jpg", type => "LinkAddr"), type => "LinkAdhoc"), type => "Image")], type => "Line"), ManulC::Parser::MD::MdEol.new(value => "", type => "Eol")], type => "Paragraph")], type => "Doc"),
        },
        {
            text => q{![Image text](/img/foo.jpg "My title")},
            name => "image with simple title",
            struct => ManulC::Parser::MD::MdDoc.new(content => [ManulC::Parser::MD::MdParagraph.new(content => [ManulC::Parser::MD::MdLine.new(content => [ManulC::Parser::MD::MdImage.new(link => ManulC::Parser::MD::MdLinkAdhoc.new(title => ManulC::Parser::MD::MdLinkAddrTitle.new(content => [ManulC::Parser::MD::MdPlainStr.new(value => "My title", type => "PlainStr")], type => "LinkAddrTitle"), text => ManulC::Parser::MD::MdLinkText.new(content => [ManulC::Parser::MD::MdLine.new(content => [ManulC::Parser::MD::MdPlainStr.new(value => "Image text", type => "PlainStr")], type => "Line")], type => "LinkText"), addr => ManulC::Parser::MD::MdLinkAddr.new(value => "/img/foo.jpg", type => "LinkAddr"), type => "LinkAdhoc"), type => "Image")], type => "Line"), ManulC::Parser::MD::MdEol.new(value => "", type => "Eol")], type => "Paragraph")], type => "Doc"),
        },
        {
            text => q{![Image "text" > &](/img/foo.jpg "My \"title\"")},
